  ...
  return (
    <>
      <header>
        <div
          id="header-sticky"
          className={`tp-header-area tp-header-style-transparent-white tp-header-sticky has-dark-logo tp-header-height ${sticky ? 'header-sticky' : ''}`}
          style={{ backgroundColor: '#C66335' }} // Black background here
        >
      ...
      {/* Embedded style override for header */}
      <style jsx>{`
        .tp-header-area {
          background-color: #C66335  !important;
        }
      `}</style>
    </>
  );
