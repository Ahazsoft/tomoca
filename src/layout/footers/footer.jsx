  ...
  return (
    <footer>
      <div className={`tp-footer-area ${primary_style?'tp-footer-style-2 tp-footer-style-primary tp-footer-style-6':''} ${style_2 ?'tp-footer-style-2':style_3 ? 'tp-footer-style-2 tp-footer-style-3': ''}`}
        ...
        <div className="tp-footer-top pt-95 pb-40 footer-section">
                  ...
                  <div className="tp-footer-widget-content">
                    ...
                    <div className="tp-footer-contact">
                      ...
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        ...
                        <div className="tp-footer-contact-content">
                          <p><a href="mailto:shofy@support.com">tomoca@support.com</a></p>
                        </div>
                      </div>
                      <div className="tp-footer-contact-item d-flex align-items-start">
                        <div className="tp-footer-contact-icon">
        ...
        <div className="tp-footer-bottom footer-section">
          <div className="container">
